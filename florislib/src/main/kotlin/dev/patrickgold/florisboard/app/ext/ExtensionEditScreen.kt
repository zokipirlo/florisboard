...
import dev.patrickgold.florisboard.core.ime.keyboard.KeyboardExtension
import dev.patrickgold.florisboard.core.ime.theme.ThemeExtension
import dev.patrickgold.florisboard.core.ime.theme.ThemeExtensionComponent
import dev.patrickgold.florisboard.core.ime.theme.ThemeExtensionComponentEditor
import dev.patrickgold.florisboard.core.ime.theme.ThemeExtensionComponentImpl
import dev.patrickgold.florisboard.core.ime.theme.ThemeExtensionEditor
import dev.patrickgold.florisboard.core.lib.ValidationResult
import dev.patrickgold.florisboard.core.lib.android.showLongToast
import dev.patrickgold.florisboard.core.lib.cache.CacheManager
import dev.patrickgold.florisboard.core.lib.compose.FlorisButtonBar
import dev.patrickgold.florisboard.core.lib.compose.FlorisIconButton
import dev.patrickgold.florisboard.core.lib.compose.FlorisInfoCard
import dev.patrickgold.florisboard.core.lib.compose.FlorisOutlinedBox
import dev.patrickgold.florisboard.core.lib.compose.FlorisOutlinedTextField
import dev.patrickgold.florisboard.core.lib.compose.FlorisScreen
import dev.patrickgold.florisboard.core.lib.compose.FlorisUnsavedChangesDialog
import dev.patrickgold.florisboard.core.lib.compose.autoMirrorForRtl
import dev.patrickgold.florisboard.core.lib.compose.defaultFlorisOutlinedBox
import dev.patrickgold.florisboard.core.lib.compose.stringRes
import dev.patrickgold.florisboard.core.lib.ext.Extension
import dev.patrickgold.florisboard.core.lib.ext.ExtensionComponent
import dev.patrickgold.florisboard.core.lib.ext.ExtensionComponentName
import dev.patrickgold.florisboard.core.lib.ext.ExtensionDefaults
import dev.patrickgold.florisboard.core.lib.ext.ExtensionEditor
import dev.patrickgold.florisboard.core.lib.ext.ExtensionJsonConfig
import dev.patrickgold.florisboard.core.lib.ext.ExtensionMaintainer
import dev.patrickgold.florisboard.core.lib.ext.ExtensionManager
import dev.patrickgold.florisboard.core.lib.ext.ExtensionMeta
import dev.patrickgold.florisboard.core.lib.ext.ExtensionValidation
import dev.patrickgold.florisboard.core.lib.ext.validate
import dev.patrickgold.florisboard.core.lib.io.FlorisRef
import dev.patrickgold.florisboard.core.lib.io.ZipUtils
import dev.patrickgold.florisboard.core.lib.io.subFile
import dev.patrickgold.florisboard.core.lib.io.writeJson
import dev.patrickgold.florisboard.core.lib.rememberValidationResult
import dev.patrickgold.florisboard.core.lib.snygg.SnyggStylesheetJsonConfig
...
fun ExtensionEditScreen(id: String, createSerialType: String?) {
    ...
    val cacheManager by lazy { FlorisboardLibrary.cacheManager }
    val extensionManager by lazy { FlorisboardLibrary.extensionManager }
...
private fun <T : ExtensionComponent> CreateComponentScreen(
    ...
    val context = LocalContext.current
    val extensionManager by lazy { FlorisboardLibrary.extensionManager }
    val themeManager by lazy { FlorisboardLibrary.themeManager }
