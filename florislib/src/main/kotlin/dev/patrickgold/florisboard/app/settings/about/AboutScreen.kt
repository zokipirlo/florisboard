...
import dev.patrickgold.florisboard.core.lib.compose.FlorisCanvasIcon
...
fun AboutScreen() = FlorisScreen {
    ...
    val clipboardManager by lazy { FlorisboardLibrary.clipboardManager }

    val appVersion = "${FlorisboardLibrary.versionName} (${FlorisboardLibrary.versionCode})"
    ...
    content {
        Column(
            ...
            FlorisCanvasIcon(
                ...
                iconId = FlorisboardLibrary.appIconId,
                contentDescription = "FlorisBoard app icon",
            )
            Text(
                text = FlorisboardLibrary.applicationName,
                fontSize = 24.sp,
        ...
        Preference(
            ...
            onClick = {
                context.launchUrl(
                    ...
                    "version" to FlorisboardLibrary.versionName
                )
            },
        )
        Preference(
