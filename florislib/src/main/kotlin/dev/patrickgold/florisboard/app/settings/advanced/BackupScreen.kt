...
import dev.patrickgold.florisboard.core.lib.android.writeFromFile
...
import dev.patrickgold.florisboard.core.lib.io.subDir
...
object Backup {
    val FILE_PROVIDER_AUTHORITY by lazy { "${FlorisboardLibrary.applicationId}.provider.file" }
...
fun BackupScreen() = FlorisScreen {
    ...
    fun prepareBackupWorkspace() {
        ...
        workspace.metadata = Backup.Metadata(
            packageName = FlorisboardLibrary.applicationId,
            versionCode = FlorisboardLibrary.versionCode,
            versionName = FlorisboardLibrary.versionName,
