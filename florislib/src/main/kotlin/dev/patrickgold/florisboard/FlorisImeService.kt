...
import dev.patrickgold.florisboard.core.ime.lifecycle.LifecycleInputMethodService
...
import dev.patrickgold.florisboard.core.ime.onehanded.OneHandedPanel
import dev.patrickgold.florisboard.core.ime.sheet.BottomSheetHostUi
import dev.patrickgold.florisboard.core.ime.sheet.isBottomSheetShowing
import dev.patrickgold.florisboard.core.ime.smartbar.ExtendedActionsPlacement
import dev.patrickgold.florisboard.core.ime.smartbar.SmartbarLayout
import dev.patrickgold.florisboard.core.ime.text.TextInputLayout
...
import dev.patrickgold.florisboard.core.lib.android.AndroidInternalR
import dev.patrickgold.florisboard.core.lib.android.AndroidVersion
import dev.patrickgold.florisboard.core.lib.android.isOrientationLandscape
import dev.patrickgold.florisboard.core.lib.android.isOrientationPortrait
import dev.patrickgold.florisboard.core.lib.android.launchActivity
import dev.patrickgold.florisboard.core.lib.android.setLocale
import dev.patrickgold.florisboard.core.lib.android.showShortToast
import dev.patrickgold.florisboard.core.lib.android.systemServiceOrNull
import dev.patrickgold.florisboard.core.lib.compose.FlorisButton
import dev.patrickgold.florisboard.core.lib.compose.ProvideLocalizedResources
import dev.patrickgold.florisboard.core.lib.compose.SystemUiIme
...
import dev.patrickgold.florisboard.core.lib.devtools.flogWarning
import dev.patrickgold.florisboard.core.lib.kotlin.collectLatestIn
import dev.patrickgold.florisboard.core.lib.observeAsTransformingState
import dev.patrickgold.florisboard.core.lib.snygg.ui.SnyggSurface
import dev.patrickgold.florisboard.core.lib.snygg.ui.shape
import dev.patrickgold.florisboard.core.lib.snygg.ui.snyggBackground
import dev.patrickgold.florisboard.core.lib.snygg.ui.snyggBorder
import dev.patrickgold.florisboard.core.lib.snygg.ui.snyggShadow
import dev.patrickgold.florisboard.core.lib.snygg.ui.solidColor
import dev.patrickgold.florisboard.core.lib.snygg.ui.spSize
import dev.patrickgold.florisboard.core.lib.util.ViewUtils
import dev.patrickgold.florisboard.core.lib.util.debugSummarize
...
class FlorisImeService : LifecycleInputMethodService() {
    ...
    private val nlpManager by lazy { FlorisboardLibrary.nlpManager }
    private val subtypeManager by lazy { FlorisboardLibrary.subtypeManager }
    private val themeManager by lazy { FlorisboardLibrary.themeManager }
    ...
    override fun onStartInputView(info: EditorInfo?, restarting: Boolean) {
        ...
        activeState.batchEdit {
            activeState.imeUiMode = dev.patrickgold.florisboard.core.ime.ImeUiMode.TEXT
    ...
    override fun onComputeInsets(outInsets: Insets?) {
        ...
        val needAdditionalOverlay =
            prefs.smartbar.enabled.get() &&
                ...
                keyboardManager.activeState.imeUiMode == dev.patrickgold.florisboard.core.ime.ImeUiMode.TEXT
                    ...
                    CompositionLocalProvider(LocalLayoutDirection provides layoutDirection) {
                        Box(
                            ...
                            when (state.imeUiMode) {
                                dev.patrickgold.florisboard.core.ime.ImeUiMode.TEXT -> TextInputLayout()
                                dev.patrickgold.florisboard.core.ime.ImeUiMode.MEDIA -> MediaInputLayout()
                                dev.patrickgold.florisboard.core.ime.ImeUiMode.CLIPBOARD -> ClipboardInputLayout()
                            }
                        }
                    }
