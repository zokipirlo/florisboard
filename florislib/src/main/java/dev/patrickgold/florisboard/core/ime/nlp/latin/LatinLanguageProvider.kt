...
package dev.patrickgold.florisboard.core.ime.nlp.latin
...
import dev.patrickgold.florisboard.core.lib.android.readText
import dev.patrickgold.florisboard.core.lib.devtools.flogDebug
import dev.patrickgold.florisboard.core.lib.kotlin.guardedByLock
...
class LatinLanguageProvider(private val appContext: Context) : SpellingProvider, SuggestionProvider {
    companion object {
