...
class SecureInputConnection(
    initState: TextFieldValue,
    val eventCallback: SecureInputConnectionCallback,
    ...
    private val TAG = "SecureInputConnection"
    private val DEBUG_CLASS = "SecureInputConnection"
    ...
    private fun toExtractedText(value: TextFieldValue): ExtractedText {
        val res = ExtractedText()
        res.text = value.text
        res.startOffset = 0
        res.partialEndOffset = value.text.length
        res.partialStartOffset = -1 // -1 means full text
        res.selectionStart = value.selection.min
        res.selectionEnd = value.selection.max
    ...
    override fun getExtractedText(request: ExtractedTextRequest?, flags: Int): ExtractedText {
        ...
        // TODO(b/135556699) should return styled text
        val extractedText = toExtractedText(mTextFieldValue)
