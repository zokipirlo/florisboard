...
package dev.patrickgold.florisboard.core.ime.clipboard.provider
...
class ClipboardMediaProvider : ContentProvider() {
    ...
    companion object {
        val AUTHORITY by lazy { "${FlorisboardLibrary.applicationId}.provider.clipboard" }
        val IMAGE_CLIPS_URI: Uri by lazy { Uri.parse("content://$AUTHORITY/clips/images") }
        val VIDEO_CLIPS_URI: Uri by lazy { Uri.parse("content://$AUTHORITY/clips/videos") }
