...
package dev.patrickgold.florisboard.core.lib.devtools
...
import dev.patrickgold.florisboard.core.lib.util.TimeUtils
import dev.patrickgold.florisboard.core.lib.util.UnitUtils
...
object Devtools {
    ...
    fun generateAppInfoLog(context: Context, withTitle: Boolean = true): String {
        return buildString {
            ...
            append("Package             : ").appendLine(FlorisboardLibrary.applicationId)
            append("Name                : ").appendLine(FlorisboardLibrary.applicationName)
            append("Version             : ").appendLine("${FlorisboardLibrary.versionName} (${FlorisboardLibrary.versionCode})")
