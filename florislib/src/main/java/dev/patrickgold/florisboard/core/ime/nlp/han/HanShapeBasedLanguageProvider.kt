...
package dev.patrickgold.florisboard.core.ime.nlp.han
...
import dev.patrickgold.florisboard.core.ime.editor.EditorContent
...
import dev.patrickgold.florisboard.core.ime.nlp.LanguagePackComponent
import dev.patrickgold.florisboard.core.ime.nlp.LanguagePackExtension
import dev.patrickgold.florisboard.core.ime.nlp.SpellingProvider
import dev.patrickgold.florisboard.core.ime.nlp.SpellingResult
import dev.patrickgold.florisboard.core.ime.nlp.SuggestionCandidate
import dev.patrickgold.florisboard.core.ime.nlp.SuggestionProvider
import dev.patrickgold.florisboard.core.ime.nlp.WordSuggestionCandidate
...
class HanShapeBasedLanguageProvider(val appContext: Context) : SpellingProvider, SuggestionProvider {
    companion object {
...
//                if (languagePack is HanShapeBasedLanguagePackExtensionImpl)
        ...
        for (activeLanguagePack in activeLanguagePacks) {
            if (!activeLanguagePack.isLoaded()) {
                ...
                activeLanguagePack.load(appContext)
            }
        }
