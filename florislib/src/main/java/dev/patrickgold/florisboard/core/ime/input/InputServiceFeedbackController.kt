...
import dev.patrickgold.florisboard.core.lib.android.systemVibratorOrNull
import dev.patrickgold.florisboard.core.lib.android.vibrate
 ...
 */
class InputServiceFeedbackController private constructor(private val ims: InputMethodService) :
    InputFeedbackController {
    companion object {
        fun new(ims: InputMethodService) = InputServiceFeedbackController(ims)
    }
