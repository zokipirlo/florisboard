...
package dev.patrickgold.florisboard.core.lib.ext
...
import dev.patrickgold.florisboard.core.ime.nlp.LanguagePackExtension
import dev.patrickgold.florisboard.core.ime.text.composing.Appender
import dev.patrickgold.florisboard.core.ime.text.composing.Composer
import dev.patrickgold.florisboard.core.ime.text.composing.HangulUnicode
import dev.patrickgold.florisboard.core.ime.text.composing.KanaUnicode
import dev.patrickgold.florisboard.core.ime.text.composing.WithRules
import dev.patrickgold.florisboard.core.ime.theme.ThemeExtension
import dev.patrickgold.florisboard.core.lib.android.FileObserver
...
import dev.patrickgold.florisboard.core.lib.io.FsFile
import dev.patrickgold.florisboard.core.lib.io.ZipUtils
import dev.patrickgold.florisboard.core.lib.io.writeJson
import dev.patrickgold.florisboard.core.lib.kotlin.throwOnFailure
...
class ExtensionManager(private val appContext: Context) {
    companion object {
    ...
    private val assetManager by lazy { FlorisboardLibrary.assetManager }
