...
package dev.patrickgold.florisboard.core.ime.keyboard
...
import dev.patrickgold.florisboard.core.ime.core.SubtypePreset
import dev.patrickgold.florisboard.core.ime.editor.FlorisEditorInfo
import dev.patrickgold.florisboard.core.ime.editor.ImeOptions
import dev.patrickgold.florisboard.core.ime.editor.InputAttributes
import dev.patrickgold.florisboard.core.ime.input.InputEventDispatcher
import dev.patrickgold.florisboard.core.ime.input.InputKeyEventReceiver
import dev.patrickgold.florisboard.core.ime.input.InputShiftState
import dev.patrickgold.florisboard.core.ime.nlp.ClipboardSuggestionCandidate
import dev.patrickgold.florisboard.core.ime.nlp.PunctuationRule
import dev.patrickgold.florisboard.core.ime.nlp.SuggestionCandidate
import dev.patrickgold.florisboard.core.ime.onehanded.OneHandedMode
import dev.patrickgold.florisboard.core.ime.popup.PopupMappingComponent
import dev.patrickgold.florisboard.core.ime.text.composing.Composer
import dev.patrickgold.florisboard.core.ime.text.gestures.SwipeAction
import dev.patrickgold.florisboard.core.ime.text.key.KeyCode
import dev.patrickgold.florisboard.core.ime.text.key.KeyType
import dev.patrickgold.florisboard.core.ime.text.key.UtilityKeyAction
import dev.patrickgold.florisboard.core.ime.text.keyboard.TextKeyData
import dev.patrickgold.florisboard.core.ime.text.keyboard.TextKeyboardCache
...
import dev.patrickgold.florisboard.core.lib.kotlin.collectIn
import dev.patrickgold.florisboard.core.lib.kotlin.collectLatestIn
import dev.patrickgold.florisboard.core.lib.kotlin.titlecase
import dev.patrickgold.florisboard.core.lib.kotlin.uppercase
...
class KeyboardManager(private val appContext: Context) : InputKeyEventReceiver {
    private val prefs by florisPreferenceModel()
    private val clipboardManager by lazy { FlorisboardLibrary.clipboardManager }
    private val editorInstance by lazy { FlorisboardLibrary.editorInstance }
    private val extensionManager by lazy { FlorisboardLibrary.extensionManager }
    ...
    private val layoutManager = LayoutManager(appContext)
        ...
        lastToastReference = WeakReference(
            if (newState) {
                appContext.showLongToast(
                    ...
                    "app_name" to FlorisboardLibrary.applicationName,
                )
            } else {
                appContext.showLongToast(
    ...
    override fun onInputKeyUp(data: KeyData) = activeState.batchEdit {
        when (data.code) {
            ...
            KeyCode.IME_UI_MODE_TEXT -> activeState.imeUiMode = dev.patrickgold.florisboard.core.ime.ImeUiMode.TEXT
            KeyCode.IME_UI_MODE_MEDIA -> activeState.imeUiMode = dev.patrickgold.florisboard.core.ime.ImeUiMode.MEDIA
            KeyCode.IME_UI_MODE_CLIPBOARD -> activeState.imeUiMode = dev.patrickgold.florisboard.core.ime.ImeUiMode.CLIPBOARD
            ...
            KeyCode.VIEW_SYMBOLS2 -> activeState.keyboardMode = KeyboardMode.SYMBOLS2
                ...
                if (activeState.imeUiMode == dev.patrickgold.florisboard.core.ime.ImeUiMode.MEDIA) {
