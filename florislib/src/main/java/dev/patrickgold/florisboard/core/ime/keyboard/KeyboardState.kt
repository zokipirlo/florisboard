...
open class KeyboardState protected constructor(open var rawValue: ULong) {
    ...
    var imeUiMode: dev.patrickgold.florisboard.core.ime.ImeUiMode
        get() = dev.patrickgold.florisboard.core.ime.ImeUiMode.fromInt(getRegion(M_IME_UI_MODE, O_IME_UI_MODE))
