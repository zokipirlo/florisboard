...
import dev.patrickgold.florisboard.core.lib.ValidationRule
...
import dev.patrickgold.florisboard.core.lib.validate
    ...
    val SnyggSolidColorValue = ValidationRule<String> {
        ...
        validator { input ->
            ...
            when {
                ...
                dev.patrickgold.florisboard.core.lib.snygg.value.SnyggSolidColorValue.deserialize(str).isFailure -> {
